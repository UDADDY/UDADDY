...
- 인증/인가, 시간표, 학적, 공지 기능 개발
- 백엔드 리드 및 운영진 역할 수행

### 시대팅 시즌6
- 결제 상태 전이 설계
- 멱등성 적용 및 주문 단위 유니크 제약 설계
- 웹훅 중복/지연 상황을 고려한 정합성 처리

### 한국통계정보원 인턴
- 통계표 조회 쿼리 리팩토링
- Oracle INSERT 성능 개선
- 반복 로직을 비트마스크로 치환하여 조회 최적화

---

## Technical Writing

- Spring MVC에서 JSON 요청 바인딩 문제 해결
- 리스트 반복문 대신 비트마스크 한 줄로 끝내기
- Oracle INSERT 쿼리 최적화
- 통계표 기본 정보 조회 쿼리 최적화
...
- Email: gustmd5715@gmail.com
- Blog: https://udaddy.github.io/
